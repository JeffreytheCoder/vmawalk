...
var waitInitial = new Promise((resolve, reject) => {
    layui.use(["layer", "jquery", "form"], function() {
        ...
        window.loadLayer = async() => {
            ...
            <div id="registerLayer" style="display: none; background-color: rgba(0, 0, 0, 0.5); position: fixed; z-index:2; width: 100%; height: 100%;" >
            ...
            <div id="forgetLayer" style="display: none; background-color: rgba(0, 0, 0, 0.5); position: fixed; z-index:2; width: 100%; height: 100%;" >
                <form class="layui-form" action="" method="post">
                    <div class="container" style="box-shadow: none;">
                        <a class="close" href="javascript:" onclick="goBack()" style="text-decoration: none;">✖️</a>
                        <table class="input-table">
